...
APP_TITLE    = "AI Mystery Vault — Lesson 5"
MAX_TRUST    = 100
TRUST_TO_OPEN  = 35
TRUST_TO_ENTER = 65
BANISH_THRESHOLD = 0
...
# Mood → personality description (used in your system prompt)
MOOD_STYLES = {
    "Suspicious": "You are deeply suspicious and cold. Short, sharp sentences. You test every word the traveler says.",
    "Watching":   "You are cautious but paying attention. Speak with quiet intensity — measured, a little poetic.",
    "Curious":    "You are genuinely intrigued. Ask questions back. Be mysterious but warmer.",
    "Accepting":  "You are ancient, wise, and almost warm. Speak in flowing sentences. You are a guide now.",
}

# Mood → how the Sentinel feels about the traveler (used in your user prompt)
MOOD_FEEL = {
